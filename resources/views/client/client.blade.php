    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="{{asset('template/assets/img/90x90.jpg')}}"> <span class="navbar-brand-name">CORK</span></a>
            </div>
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="text-right">@foreach ($client as $row )
                                   @php
                                    ...
                                    @endphp
                                    @endforeach
                                    <a href="{{url("/dossiers/new/$idclient")}}" class="btn btn-outline-info"  >Ajouter un dossier</a>
                                </div>
                                <table class="table mb-4">
                                    <caption>Listes des dossiers </caption>
                                    <thead>
                                          <tr>
                                              <th class="text-center">#</th>
                                              <th>Numero Dossier</th>
                                              <th>Numero declaration</th>
                                              <th>agence maritim</th>
                                              <th class="">Status</th>
                                              <th>date</th>
                                              <th>action</th>
                                          </tr>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                              ...
                                              <td class="text-primary">{{$row->numdossier}}</td>
                                              <td>{{$row->numdeclaration}}</td>
                                              <td>{{$row->agencemaritime}}</td>
                                              <td class="">
                                                @if ($row->observations == '1')  
                                                <span class="shadow-none badge badge-primary">Valider</span>
                                                @elseif ($row->observations == '2')  
                                                <span class="shadow-none badge badge-danger">Cloturer</span>
                                                @else
                                              ...
                                              <td class="text-center">
                                                <a href="{{url("/dossiers/show/$row->id")}}" class="btn btn-outline-primary"  >Voir</a></td>                                          </tr>
                                          @endforeach
                                      </tbody>
                                  </table>
                            </div>
