                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class=' shadow-none badge outline-badge-primary'>en attente du Fournisseur</span>
                                                    @elseif ($row->status == 4)

                                                    <span class=' shadow-none badge outline-badge-success'>Devis Clôturer</span>
                                                        ...
                                                        <div class="dropdown custom-dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                               ...
                                                               @endif
                                                                ...
                                                                <a class="dropdown-item" href="{{url("/devis/arrete/$row->id")}}">Traiter</a>
