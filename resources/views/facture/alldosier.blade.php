                                    ...
                                    <table id="style-2" class="table style-2  table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Numero BL </th>
                                                <th>Cree le</th>
                                                <th>Date arrivee Navire</th>
                                                <th>Destination Marchandise</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$row->datearrivee_navire}}</td>
                                                <td>{{$row->destination_marchandise}}</td>
...
@endif
                                                ...
                                                <td class="text-center">
                                                    <a href="{{url("/facture/show/$row->id")}}" class="btn btn-outline-danger"  >Voir la facture</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
