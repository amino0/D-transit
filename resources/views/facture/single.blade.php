                ...
                <div class="row layout-spacing">
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="bio layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <h3 class="">Description Dossier</h3>
                                            <b>Num de Declaration</b> : @foreach ($dossier as $row)
                                            {{$row->numdossier}}
                                            @endforeach
                                            <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 ">
                                            ...
                                            <div class="d-flex b-skills">
                                                ...
                                                <a href="{{url('/marchandises')}}">Voir plus</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 ">
                                            ...
                                            <div class="d-flex b-skills">
                                                ...
                                                <div class="">
                                                    ...
                                                    <a href="{{url('/conteneur')}}">Voir plus</a>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ajouter d'un Debours pour @foreach ($dossier as $row)
                                    {{$row->numdossier}}                                    
                                @endforeach </h5>
                            ...
                            <div class="modal-body">
                               <form action="{{url('/new/debours')}}" accept="" method="POST">
                                <div class="input-group mb-4">
                                    <input type="text" class="form-control" name="intituler" placeholder="Intituler" aria-label="notification" aria-describedby="basic-addon2" required>
