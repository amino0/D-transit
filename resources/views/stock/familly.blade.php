                                    ...
                                    <table id="style-2" class="table style-2  table-hover">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                                ...
                                                <td>
                                                    <span class=' shadow-none badge outline-badge-warning'>En stock </span>
                                                   
                                                    </td>
                                                    <td>{{$row->created_at}}</td>

                                                <td class="text-center">
                                                    <a href="{{url("/commandes/$row->id_commande")}}" class="btn btn-outline-warning"  >Transiter</a>
                                                    <a href="{{url("/vendre/$row->id_commande")}}" class="btn btn-outline-danger"  >Vendre</a>
                                                </td>
                                            </tr>
