                                ...
                                <div class="table-responsive mb-4">
                                    <table id="style-2" class="table style-2  table-hover">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>Nom ou accronime</th>
                                                <th>Telephone</th>   
                                                <th class="text-center">Pays</th>
                                                <th class="text-center">Créée le</th>
                                                <th class="text-center">Nb commande</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                          ...
                                          <tr>
                                                ...
                                                <td class="text-center">
                                                    <span class=' shadow-none badge outline-badge-primary'> 10 Commandes </span>
           ...
           <div class="modal fade" id="ajoutfournissuer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="{{url('/paramettre/fournisseur/add')}}">
                        @csrf
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Nom ou accronime</label>
                            <input type="text" name="nom_fourni" class="form-control" id="exampleFormControlInput2" placeholder="nom fournisseur" required>
                        </div>
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Numero de Telephone</label>
                            <input type="number" name="tel_fourni" class="form-control" id="exampleFormControlInput2" placeholder="+253 77 ....." required>
                        </div>
                        <div class="form-group mb-4">
                            <label for="exampleFormControlInput2">Adresse </label>
                            <input type="text" name="adresse_fourni" class="form-control" id="exampleFormControlInput2" placeholder="Turkey, Anakara, cankaya" required>
                        </div>
