                ...
                <div class="row layout-spacing">
                    ...
                    <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <h3 class="">Nouveau Dossier pour le client  {{$nomclient}}</h3>
                             
                                <div class="text-right">
                                </div>
                                
                                <form method="post" action="{{url('/newdossier')}}">
                                    <div class="form-group">
                                        <label for="t-text" class="sr-only">Numero dossier</label>
                                        <input id="t-text" type="text" name="txt" placeholder="Numero du  dossier..." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="numdeclaration" class="sr-only">Numero Declaration</label>
                                        <input id="numdeclaration" type="text" name="txt" placeholder="Numero Declaration..." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="destinataire" class="sr-only">Destinataire</label>
                                        <input id="destinataire" type="text" name="txt" placeholder="Desninataire..." class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="bl_number" class="sr-only">BL number</label>
                                        <input id="bl_number" type="text" name="txt" placeholder="Numero du BL..." class="form-control" required>
                                    </div>
                               ...
                               <form action="{{url('/new/debours')}}" accept="" method="POST">
                                ...
                                <div class="input-group mb-4">
                                  ...
                                  <div class="custom-file-container" data-upload-id="myFirstImage">
                                    <label>Upload (Un seul Fichier) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
